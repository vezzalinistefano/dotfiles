...
_G.packer_plugins = {
  ...
  ["cmp-cmdline"] = {
    loaded = true,
    path = "/home/sv/.local/share/nvim/site/pack/packer/start/cmp-cmdline",
  ...
  ["nvim-base16"] = {
    loaded = true,
    path = "/home/sv/.local/share/nvim/site/pack/packer/start/nvim-base16",
  ...
  ["tempus-themes-vim.git"] = {
    loaded = true,
    path = "/home/sv/.local/share/nvim/site/pack/packer/start/tempus-themes-vim.git",
  ...
  ["zephyr-nvim"] = {
    loaded = true,
    path = "/home/sv/.local/share/nvim/site/pack/packer/start/zephyr-nvim",
